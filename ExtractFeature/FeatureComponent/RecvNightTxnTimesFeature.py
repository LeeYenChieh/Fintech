...
class RecvNightTxnTimesFeature(FeatureDecorator):
    ...
    def getFeature(self):
        ...
        df_feature = df_night['acct'].value_counts().rename("recv_night_txn")
        result.append(df_feature)

        print("(Finish) Extract Recv Night Transaction Feature")
